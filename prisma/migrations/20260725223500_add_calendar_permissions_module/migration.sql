-- Insert calendar module and grant permissions to system ADMIN roles
INSERT INTO "modules" ("id", "name", "label")
SELECT gen_random_uuid()::text, 'calendar', 'Calendário'
WHERE NOT EXISTS (
  SELECT 1 FROM "modules" WHERE "name" = 'calendar'
);
